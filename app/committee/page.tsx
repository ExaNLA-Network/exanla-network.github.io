...
const committeeMembers: CommitteeMember[] = [
  ...
  },
  {
    ...
    categories: [expertiseCategories.HPC, expertiseCategories.LOW_LEVEL_OPTIMIZATION, expertiseCategories.PARALLEL_PROGRAMMING, expertiseCategories.AIx],
    workingGroups: [WorkingGroups.PERFORMANCE_PARALLELIZATION],
  },
  {
    id: 'ben.hourahine',
    ...
    bio: '25+ years of experience in HPC, materials modeling and
    method development, including founding developer of the DFTB+
    project and various computational physics projects including a
    high-precision semi-analytical electromagnetic solver, Monte Carlo
    tools for simulating crystal growth and machine learning for
    semi-empirical electronic structure and scanning electron
    microscopy',
