        ...
        loadedResponses.forEach(response => {
          if (op.id === 'symmetric-hermitian') {
            ...
            if (response['symmetric-hermitian'] === true) {
              op.usageCount++;
              const appName = response['library-name'] || 'undefined';
              if (!op.applications.includes(appName)) {
                op.applications.push(appName);
              }
            }
            ...
            >
              ...
              <div className="text-xs">
                ...
                <div className="flex flex-wrap gap-1">
                  {operation.applications.length > 0 ? (
                    ...
                    <span className="px-2 py-1 bg-white bg-opacity-50 rounded text-xs text-gray-500">
                      No applications
                    </span>
                  )}
                </div>
